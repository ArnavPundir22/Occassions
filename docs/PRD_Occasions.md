...
- **In-App Live Streaming:** This is purely for registration and management, not virtual event hosting.
- **Complex Ticketing Tiers:** V1 will not support VIP vs. General Admission; it will be a single RSVP list.
- **Mobile Native App:** The platform will be mobile-responsive via web, but no iOS/Android native apps will be developed in V1.
